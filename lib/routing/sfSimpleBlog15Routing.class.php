...
class sfSimpleBlog15Routing
{
  static public function listenToRoutingLoadConfigurationEvent(sfEvent $event)
  {
    ...
    $r->prependRoute('sf_simple_blog_posts_feed', new sfRoute('/posts/:format', array('module' => 'sfSimpleBlog', 'action' => 'postsFeed', 'format' => 'atom1')));
    $r->prependRoute('sf_simple_blog_comments_feed', new sfRoute('/comments/:format', array('module' => 'sfSimpleBlog', 'action' => 'commentsFeed', 'format' => 'atom1')));
    $r->prependRoute('sf_simple_blog_posts_tag_feed', new sfRoute('/tags/:tag/:format', array('module' => 'sfSimpleBlog', 'action' => 'postsForTagFeed', 'format' => 'atom1')));
    if (sfConfig::get('app_sfSimpleBlog_use_date_in_url', false))
    {
      ...
      $r->prependRoute('sf_simple_blog_comments_post_feed', new sfRoute('/:year/:month/:day/:stripped_title/comments/:format', array('module' => 'sfSimpleBlog', 'action' => 'commentsForPostFeed', 'format' => 'atom1')));
    }
    else
    {
      $r->prependRoute('sf_simple_blog_show', new sfRoute('/:stripped_title', array('module'=>'sfSimpleBlog', 'action'=>'show')));
      $r->prependRoute('sf_simple_blog_comments_post_feed', new sfRoute('/:stripped_title/comments/:format', array('module' => 'sfSimpleBlog', 'action' => 'commentsForPostFeed', 'format' => 'atom1')));
    }
