...
/**
 * Base class that represents a row from the 'sf_blog_category' table.
 *
 * 
 *
 ...
 */
abstract class BasesfSimpleBlogCategory extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'sfSimpleBlogCategoryPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        sfSimpleBlogCategoryPeer
	 */
	...
	protected function loadDescription(PropelPDO $con = null)
	{
		...
		$c->addSelectColumn(sfSimpleBlogCategoryPeer::DESCRIPTION);
		try {
			$stmt = sfSimpleBlogCategoryPeer::doSelectStmt($c, $con);
	 ...
	 * @return     sfSimpleBlogCategory The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = sfSimpleBlogCategoryPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = sfSimpleBlogCategoryPeer::NAME;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = sfSimpleBlogCategoryPeer::DESCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = sfSimpleBlogCategoryPeer::NUM_COLUMNS - sfSimpleBlogCategoryPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating sfSimpleBlogCategory object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = sfSimpleBlogCategoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
		$row = $stmt->fetch(PDO::FETCH_NUM);
		$stmt->closeCursor();
		if (!$row) {
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BasesfSimpleBlogCategory:delete:pre') as $callable)
			{
			...
			if ($ret) {
				sfSimpleBlogCategoryQuery::create()
					->filterByPrimaryKey($this->getPrimaryKey())
					->delete($con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasesfSimpleBlogCategory:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BasesfSimpleBlogCategory:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasesfSimpleBlogCategory:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				sfSimpleBlogCategoryPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(sfSimpleBlogCategoryPeer::ID) ) {
					...
					$affectedRows = sfSimpleBlogCategoryPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = sfSimpleBlogCategoryPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = sfSimpleBlogCategoryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['sfSimpleBlogCategory'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['sfSimpleBlogCategory'][$this->getPrimaryKey()] = true;
		$keys = sfSimpleBlogCategoryPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfSimpleBlogCategoryPeer::ID)) $criteria->add(sfSimpleBlogCategoryPeer::ID, $this->id);
		if ($this->isColumnModified(sfSimpleBlogCategoryPeer::NAME)) $criteria->add(sfSimpleBlogCategoryPeer::NAME, $this->name);
		if ($this->isColumnModified(sfSimpleBlogCategoryPeer::DESCRIPTION)) $criteria->add(sfSimpleBlogCategoryPeer::DESCRIPTION, $this->description);
	...
	{
		$criteria = new Criteria(sfSimpleBlogCategoryPeer::DATABASE_NAME);
		$criteria->add(sfSimpleBlogCategoryPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of sfSimpleBlogCategory (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     sfSimpleBlogCategory Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     sfSimpleBlogCategoryPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new sfSimpleBlogCategoryPeer();
		}
		return self::$peer;
	}
	 ...
	 * If this sfSimpleBlogCategory is new, it will return
		...
		if(null === $this->collsfSimpleBlogPostCategorys || null !== $criteria) {
			if ($this->isNew() && null === $this->collsfSimpleBlogPostCategorys) {
				...
				$collsfSimpleBlogPostCategorys = sfSimpleBlogPostCategoryQuery::create(null, $criteria)
					->filterBysfSimpleBlogCategory($this)
					->find($con);
				if (null !== $criteria) {
	...
	public function addsfSimpleBlogPostCategory(sfSimpleBlogPostCategory $l)
	{
		...
		if (!$this->collsfSimpleBlogPostCategorys->contains($l)) { // only add it if the **same** object is not already associated
			...
			$l->setsfSimpleBlogCategory($this);
		}
	}
	 ...
	 * Otherwise if this sfSimpleBlogCategory is new, it will return
	 * an empty collection; or if this sfSimpleBlogCategory has previously
	 * been saved, it will retrieve related sfSimpleBlogPostCategorys from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfSimpleBlogCategory.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array sfSimpleBlogPostCategory[] List of sfSimpleBlogPostCategory objects
	 */
	public function getsfSimpleBlogPostCategorysJoinsfSimpleBlogPost($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = sfSimpleBlogPostCategoryQuery::create(null, $criteria);
		$query->joinWith('sfSimpleBlogPost', $join_behavior);
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BasesfSimpleBlogCategory:' . $name))
		{
